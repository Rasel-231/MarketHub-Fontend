"use client";
import { EmailIcon, FacebookIcon } from "@/features/auth/components/Icons";
...
const IconGrid = () => {
  ...
  const outerIcons = [
    { id: 1, component: <Truck /> },
    { id: 2, component: <FacebookIcon /> },
    { id: 3, component: <EmailIcon /> },
    { id: 4, component: <ShoppingCart /> },
    { id: 5, component: <DollarSign /> },
    { id: 6, component: <Locate /> },
