      ...
      <div className="container relative z-10 mx-auto flex h-full items-center justify-center px-6">
        <div className="max-w-3xl text-center text-white">
          ...
          <motion.h1
            ...
            className="mb-4 text-3xl font-extrabold tracking-tight sm:text-4xl md:text-6xl lg:text-7xl"
          >
            Elevate Your <span className="text-primary">Style</span> with
            MarketHub
          </motion.h1>
          ...
          <div className="mb-8 min-h-[60px] text-sm font-light text-gray-200 sm:text-base md:text-lg lg:text-xl cursor-default">
            <Typewriter
              options={{
                strings: [
                  "Experience the future of online shopping.High-quality products at your fingertips.Exclusive deals and lightning-fast delivery.Everything you need, everywhere you go.",
                ],
                autoStart: true,
                loop: true,
                delay: 60,
