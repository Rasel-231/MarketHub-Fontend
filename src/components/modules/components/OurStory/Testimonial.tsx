...
const teamMembers: TeamMember[] = [
    { name: 'Zane Whitaker', role: 'Seller', imageUrl: 'https://i.postimg.cc/W1rCvYnT/nazmul-hossain.jpg' },
    { name: 'Emily Jonson', role: 'Seller', imageUrl: 'https://i.pinimg.com/736x/8c/6d/db/8c6ddb5fe6600fcc4b183cb2ee228eb7.jpg' },
    { name: 'Harshita Patel', role: 'Seller', imageUrl: 'https://i.pinimg.com/736x/6f/a3/6a/6fa36aa2c367da06b2a4c8ae1cf9ee02.jpg' },
    { name: 'Eleanor Morales', role: 'Seller', imageUrl: 'https://i.pinimg.com/1200x/c2/4e/27/c24e271f2f992fd7e62e8c1e8d9b3e2f.jpg' },
    { name: 'Sophia Monic', role: 'Buyer', imageUrl: 'https://i.pinimg.com/736x/81/d6/b1/81d6b158728f5fc97ca6e0a025fefee0.jpg' },
    { name: 'James Miller', role: 'Buyer', imageUrl: 'https://i.pinimg.com/736x/9f/46/74/9f4674ca9c17330ab419c1b2f5951d9a.jpg' },
    { name: 'Olivia Chen', role: 'Buyer', imageUrl: 'https://i.pinimg.com/736x/57/3c/80/573c80967c9429d0ed0ce32701f85b70.jpg' },
    { name: 'Benjamin Carter', role: 'Investor', imageUrl: 'https://i.pinimg.com/736x/b0/c4/21/b0c421e77cf563962026ade82c90dd5b.jpg' },
    { name: 'Ava Rodriguez', role: 'Investor', imageUrl: 'https://i.pinimg.com/736x/ce/31/42/ce3142d7a968fff3aecd0100572a5e8b.jpg' },
    { name: 'Lucas Garcia', role: 'Buyer', imageUrl: 'https://i.pinimg.com/736x/79/63/a5/7963a5246188d408b8f28961a0cf2b90.jpg' },
    { name: 'Mia Martinez', role: 'Buyer & Seller', imageUrl: 'https://i.pinimg.com/736x/8e/c1/f8/8ec1f80db272047cedf4c20263114387.jpg' },
    { name: 'Henry Wilson', role: 'Manger', imageUrl: 'https://i.pinimg.com/1200x/08/a2/41/08a2413b771b729a9f9df20fa97be52a.jpg' },
];
  ...
  return (
    <div className="group flex flex-col items-center text-center p-6 bg-white dark:bg-gray-900 rounded-2xl shadow-sm hover:shadow-xl dark:shadow-gray-900/20 dark:hover:shadow-gray-900/40 transition-all duration-300 border border-gray-100 dark:border-gray-800 hover:border-gray-200 dark:hover:border-gray-700 hover:-translate-y-1">
      <div className="relative w-32 h-32 md:w-40 md:h-40 mb-4 overflow-hidden rounded-full">
        <div className="absolute inset-0 bg-gradient-to-br from-blue-400 via-purple-500 to-pink-500 rounded-full opacity-0 group-hover:opacity-20 transition-opacity duration-300 z-10"></div>
        <Image
          className="relative rounded-full object-cover ring-4 ring-white dark:ring-gray-800 group-hover:ring-gray-100 dark:group-hover:ring-gray-700 transition-all duration-300"
          src={member.imageUrl}
          alt={`Portrait of ${member.name}`}
          fill // Container এর পুরো সাইজ অনুযায়ী ইমেজ নিতে সাহায্য করে
