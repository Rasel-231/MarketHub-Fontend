...
import { useCreateProductMutation } from "@/components/Redux/api/productsApi/productsApi";
...
const UploadProducts = () => {
  ...
  if (isProfileLoading)
    return <div className="text-center py-20 font-bold">Loading Seller Info...</div>;
